...
position_choices = (("coordinator", "Coordinator"), ("instructor", "Instructor"))
...
class Profile(models.Model):
    ...
    position = models.CharField(
        ...
        default="coordinator",
        help_text="Select Coordinator if you want to organise a workshop in your college/school. Select Instructor if you want to conduct a workshop.",
    )
...
class WorkshopType(models.Model):
    ...
    duration = models.PositiveIntegerField(
        help_text="Please enter duration in days", validators=[MinValueValidator(1)]
    )
...
class Workshop(models.Model):
    ...
    workshop_type = models.ForeignKey(
        WorkshopType, on_delete=models.CASCADE, help_text="Select the type of workshop."
    )
    date = models.DateField()
    STATUS_CHOICES = [(0, "Pending"), (1, "Accepted"), (2, "Deleted")]
