...
class UserRegistrationForm(forms.Form):
    ...
    department = forms.ChoiceField(
        help_text="Department you work/study", choices=department_choices
    )
    ...
    def clean_username(self):
        ...
        if u_name.strip(UNAME_CHARS):
            msg = "Only letters, digits, period  are allowed in username"
    ...
    def clean_password(self):
        ...
        if pwd.strip(PWD_CHARS):
            raise forms.ValidationError(
                "Only letters, digits and punctuation\
...
class WorkshopForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "workshop_type": forms.Select(attrs={"class": "form-control"}),
...
class ProfileForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["department"].widget.attrs.update({"class": "custom-select"})
        self.fields["title"].widget.attrs.update({"class": "custom-select"})
        self.fields["state"].widget.attrs.update({"class": "custom-select"})
